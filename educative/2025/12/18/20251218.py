# https://www.educative.io/courses/ds-and-algorithms-in-python/nth-to-last-node
# Linked lists -
...
print("print second last element:")
linked_list.print_nth_from_last(2)

print("print third last element:")
linked_list.print_nth_from_last(3)

# summary (17 minutes today)
# - wrapped up
# Up next:
# https://www.educative.io/courses/ds-and-algorithms-in-python/count-occurrences
